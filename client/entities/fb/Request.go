...
func (rcv *Request) DateStart() []byte {
...
func RequestAddDateStart(builder *flatbuffers.Builder, dateStart flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(0, flatbuffers.UOffsetT(dateStart), 0)
}
func RequestAddDateEnd(builder *flatbuffers.Builder, dateEnd flatbuffers.UOffsetT) {
	builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(dateEnd), 0)
}
